...
class Element {
   ...
   async evaluate(options = {}) {
      ...
      if (objectId) {
         ...
         // 获取初始document资源引用id
         let message = await this.page.send('Runtime.evaluate', {
         ...
         if (message) {
            ...
            let { className, description, objectId } = message.result
            ...
            throw new Error('获取document objectId失败')
   ...
   async focus() {
      ...
      await this.page.clicker.click(300, 100)
